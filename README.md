...
3. **Configura las variables de entorno**:
    ...
    Copia el archivo `.env.example` a `.env` y configura las variables necesarias (base de datos, correos, etc.):
...
## Autores
<a href="https://github.com/AbrahamVM2001/nubox/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=AbrahamVM2001/nubox" />
</a>
