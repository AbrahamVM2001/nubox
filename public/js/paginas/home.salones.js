$(function () {
    ...
    async function fetchSalones() {
        try {
            let peticion = await fetch(servidor + `login/mostrarSalones`);
            ...
            <div class="col-sm-12 col-md-4 mt-5">
                <div class="card">
                    ...
                    <div class="card-title p-3">
                        ...
                        <a href="${servidor}UlhOd1lXTnBiM009/salon/${btoa(btoa(item.id_espacio))}" class="btn btn-primary">Reservar</a>
                    </div>
                </div>
            </div>
        `;
            $("#galeria").append(salones);
        });
    }
