...
<!-- contenedores -->
<div class="panel">
    <h1>Pregunta rápida / votación</h1>
    <input type="hidden" id="idSesion" name="idSesion">
</div>
<div class="panel-votacion" id="panel-votacion">
</div>
<script src="<?= constant('URL') ?>public/js/paginas/user/home.votacion.js"></script>
