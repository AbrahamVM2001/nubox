                        ...
                        <form id="form-new-reservacion" action="javascript:;" class="needs-validation" novalidate method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-6 mt-2">
                                    <label for="fecha_incio">Fecha de inicio <span>*</span></label>
                                    <input type="datetime-local" class="form-control" name="fechaInicio" id="fechaInicio" required>
                                    <div class="invalid-feedback">
                                        Ingresa la fecha de inicio, por favor.
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-12 col-lg-6 mt-2">
                                    <label for="fecha_finalizacion">Fecha de finalizacion <span>*</span></label>
                                    <input type="datetime-local" class="form-control" name="fechaFinalizacion" id="fechaFinalizacion" required>
                                    <div class="invalid-feedback">
