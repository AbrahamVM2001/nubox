...
<body class="bg-gray-100">
    ...
    <!-- home -->
    <section id="inicio-salon" class="d-flex align-items-center justify-content-center" style="height: 100vh;">
        <div class="container text-center">
            <div class="row">
                <div class="col-sm-12 col-md-4"></div>
                <div class="col-sm-12 col-md-4"></div>
                <div class="col-sm-12 col-md-4">
                    <h1 style="color: #fff;">Salones de calidad para cualquiera de tus eventos</h1>
                    <p style="color: #fff;">Solo necesitas agendar la reservacion y pagar y listo tendrás todo los beneficios.</p>
                </div>
            </div>
        </div>
    </section>
    <!-- galeria de salones -->
    <section id="galeria-salones">
        <div class="container">
