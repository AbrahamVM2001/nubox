...
<body class="bg-gray-100">
    ...
    <!-- home -->
    <div class="container d-flex justify-content-center align-items-center" style="height: 100vh;" id="verificar">
        <div class="row">
            <form class="needs-validation" id="form-new-cambiarContrasena" action="javascript:;" novalidate method="post">
                ...
                <button data-formulario="form-new-cambiarContrasena" type="button" class="action btn-restaurar">Restaurar</button>
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        let id_usuario = '<?= $this->cambiarContrasena ?>';
    </script>
    ...
    <script src="<?= constant('URL') ?>public/js/paginas/home.cambiarContrasena.js"></script>
</body>
