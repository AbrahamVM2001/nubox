...
<body class="bg-gray-100">
    ...
    <!-- menu -->
    <nav style="background-color: rgba(255, 255, 255, 0.86);">
        <div class="wrapper">
    ...
    <!-- home -->
    <section id="inicio-oficinas" class="d-flex align-items-center justify-content-center" style="height: 100vh;">
        <div class="container text-center">
            <div class="row">
                <div class="col-sm-12 col-md-4"></div>
                <div class="col-sm-12 col-md-4"></div>
                <div class="col-sm-12 col-md-4">
                    <h1 style="color: #fff;">Haz que tu marca se destaque y deje una impresión duradera.</h1>
                    <p style="color: #fff;">Renta una oficina y haz que tu marca se destaque. Con solo un clic en "Reservar" y el pago de tu primera mensualidad, podrás disfrutar de numerosas ventajas exclusivas.</p>
                </div>
            </div>
        </div>
    </section>
    <!-- galeria de salones -->
    <section id="galeria-oficinas">
        <div class="container">
    ...
    <script src="<?= constant('URL') ?>public/js/paginas/home.oficinas.js"></script>
