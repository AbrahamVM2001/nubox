...
<body class="bg-gray-100">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <p>Para restablecer tu contraseña, ingresa el correo electrónico que proporcionaste previamente. Te enviaremos un correo con un código de verificación que deberás introducir para continuar con el proceso y actualizar tu contraseña.
                    </p>
                </div>
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 text-center">
                    <form id="form-new-contrasena" action="javascript:;" class="needs-validation" novalidate method="post">
                        <label for="correo">Ingresa tu correo</label>
                        <input type="text" class="form-control mt-3" name="correoConfir" id="correoConfir" placeholder="example@nubox.com" required>
                ...
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 text-center mt-2">
                    <button data-formulario="form-new-contrasena" type="button" class="btn btn-primary btn-buscar-correo">Restaurar contraseña</button>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-4">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item mb-2"><a href="<?= constant('URL') ?>" class="nav-link p-0 text-body-secondary">Inicio</a></li>
                        <li class="nav-item mb-2"><a href="<?= constant('URL') ?>#about" class="nav-link p-0 text-body-secondary">Quienes somos</a></li>
                        <li class="nav-item mb-2"><a href="<?= constant('URL') ?>#carrusel-salones" class="nav-link p-0 text-body-secondary">Salones</a></li>
                        <li class="nav-item mb-2"><a href="<?= constant('URL') ?>#carrusel-oficinas" class="nav-link p-0 text-body-secondary">Oficinas</a></li>
                        <li class="nav-item mb-2"><a href="<?= constant('URL') ?>#informacion" class="nav-link p-0 text-body-secondary">Información</a></li>
                        <li class="nav-item mb-2"><a href="<?= constant('URL') ?>#objetivo" class="nav-link p-0 text-body-secondary">Servicios</a></li>
                        <li class="nav-item mb-2"><a href="<?= constant('URL') ?>#opinion" class="nav-link p-0 text-body-secondary">CEO</a></li>
                    </ul>
                </div>
                <div class="col-sm-12 col-md-4 mt-4">
                    <ul class="nav flex-column">
                        <li class="nav-item mb-2"><a href="<?= constant('URL') ?>login/salones" class="nav-link p-0 text-body-secondary">Salones</a></li>
                        <li class="nav-item mb-2"><a href="<?= constant('URL') ?>login/oficinas" class="nav-link p-0 text-body-secondary">Oficinas</a></li>
    ...
    <script src="<?= constant('URL') ?>public/js/paginas/home.contrasena.js"></script>
    <script>
